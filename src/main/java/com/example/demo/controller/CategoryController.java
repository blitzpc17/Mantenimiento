...
public class CategoryController {
	...
	public String mostrarFormulario(Model model) {
		...
		return "InsertCategory"; // Asegúrate de que este archivo exista en templates/
	}
	...
	public String category(@RequestParam("cat") String categoria, Model model) {
		...
		if (!categoria.isEmpty()) {
			...
			model.addAttribute("mensaje", "Categoria: " + categoria + " creada correctamente!");
			return "InsertCategory";
		}
	...
	public String editar(@PathVariable(name = "id") Integer idcat,
		...
		try {
			...
			model.addAttribute("mensaje", "Categoria: " + categoria + " Editada Exitosamente!");
	...
	public String search(@RequestParam("buscar") String cat, Model model) {
		List<Category> encontrarcategoria = repocate.findByCatContainingIgnoreCase(cat);
