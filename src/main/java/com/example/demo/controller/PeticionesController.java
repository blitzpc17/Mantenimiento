...
public class PeticionesController {
	...
	public String peticion(@RequestParam("id") Integer idmain,
		...
		// Optional<InventarioEntity> inventariopeticionactualizada =
		// InventarioRepository.findById(idmain);
	 ...
	 * public ResponseEntity<byte[]> generarReportePdf(@PathVariable("id") Integer
	 * id) {
	 ...
	 * headers.setContentDispositionFormData("filename", "reporte_peticion_" + id +
	 * ".pdf");
	 * 
	...
	public String indexPrecargado(@RequestParam("materialId") Integer materialId, Model model) {
		...
		model.addAttribute("materialId", 10000);
